...
use std::sync::Once;
use wai_bindgen_gen_core::wai_parser::Interface;
use wai_bindgen_gen_core::Generator;
use wai_bindgen_rust::Handle;

wai_bindgen_rust::export!("./crates/wai-bindgen-demo/demo.wai");
wai_bindgen_rust::import!("./crates/wai-bindgen-demo/browser.wai");
