            ...
            pub mod symmetric_executor {
                ...
                impl CallbackFunction {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ =
                            unsafe { _rt::Box::from_raw(handle as *mut _CallbackFunctionRep<T>) };
                    }
                ...
                impl CallbackData {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe { _rt::Box::from_raw(handle as *mut _CallbackDataRep<T>) };
                    }
                ...
                impl EventSubscription {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ =
                            unsafe { _rt::Box::from_raw(handle as *mut _EventSubscriptionRep<T>) };
                    }
                ...
                impl EventGenerator {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe { _rt::Box::from_raw(handle as *mut _EventGeneratorRep<T>) };
                    }
                ...
                impl CallbackRegistration {
                    ...
                    pub fn new<T: GuestCallbackRegistration>(val: T) -> Self {
                        ...
                        let ptr: *mut _CallbackRegistrationRep<T> =
                            _rt::Box::into_raw(_rt::Box::new(val));
                        unsafe { Self::from_handle(T::_resource_new(ptr.cast())) }
                    }
                    ...
                    // It's theoretically possible to implement the `GuestCallbackRegistration` trait twice
                    // so guard against using it with two different types here.
                    #[doc(hidden)]
                    fn type_guard<T: 'static>() {
                        use core::any::TypeId;
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe {
                            _rt::Box::from_raw(handle as *mut _CallbackRegistrationRep<T>)
                        };
                    }
