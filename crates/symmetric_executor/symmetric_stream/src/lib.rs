...
impl GuestStreamObj for StreamObj {
    ...
    fn start_reading(&self, buffer: symmetric_stream::Buffer) {
        ...
        #[cfg(feature = "trace")]
        println!("Stream::start_read {:x} {buf:x?} {size} =>", self.0.read_ready_event_send.handle());
    ...
    fn read_result(&self) -> Option<symmetric_stream::Buffer> {
        ...
        #[cfg(feature = "trace")]
        println!("Stream::read_result {:x} {addr:x?} {size}", self.0.read_ready_event_send.handle());
    ...
    fn start_writing(&self) -> symmetric_stream::Buffer {
        ...
        #[cfg(feature = "trace")]
        println!("Stream::start_write {:x} {addr:x?} {size}", self.0.read_ready_event_send.handle());
    ...
    fn finish_writing(&self, buffer: Option<symmetric_stream::Buffer>) -> () {
        ...
        #[cfg(feature = "trace")]
        println!("Stream::finish_write {:x} {addr:x?} {elements} =>", self.0.read_ready_event_send.handle());
