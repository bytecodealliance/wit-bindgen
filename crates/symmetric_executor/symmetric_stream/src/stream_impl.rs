            ...
            pub mod symmetric_stream {
                ...
                impl Address {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe { _rt::Box::from_raw(handle as *mut _AddressRep<T>) };
                    }
                ...
                impl Buffer {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe { _rt::Box::from_raw(handle as *mut _BufferRep<T>) };
                    }
                ...
                impl StreamObj {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe { _rt::Box::from_raw(handle as *mut _StreamObjRep<T>) };
                    }
                ...
                pub unsafe fn _export_method_stream_obj_is_write_closed_cabi<T: GuestStreamObj>(
                    ...
                    unsafe {
                        ...
                        _rt::run_ctors_once();
                        let result0 =
                            { T::is_write_closed(StreamObjBorrow::lift(arg0 as usize).get()) };
                        match result0 {
                            true => 1,
                            false => 0,
                        }
                ...
                >(
                    ...
                    unsafe {
                        ...
                        _rt::run_ctors_once();
                        let result0 =
                            { T::is_ready_to_write(StreamObjBorrow::lift(arg0 as usize).get()) };
                        match result0 {
                            true => 1,
                            false => 0,
                        }
