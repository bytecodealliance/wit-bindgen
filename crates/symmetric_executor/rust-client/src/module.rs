...
pub mod symmetric {
    pub mod runtime {
        ...
        pub mod symmetric_stream {
            ...
            use super::super::super::_rt;
            pub type EventGenerator =
                super::super::super::symmetric::runtime::symmetric_executor::EventGenerator;
            ...
            impl StreamObj {
                #[allow(unused_unsafe, clippy::all)]
                pub fn read_ready_event(&self) -> EventGenerator {
                    unsafe {
                        #[link(wasm_import_module = "symmetric:runtime/symmetric-stream@0.1.0")]
                        extern "C" {
                            #[cfg_attr(
                                target_arch = "wasm32",
                                link_name = "[method]stream-obj.read-ready-event"
                            )]
                            fn symmetricX3AruntimeX2Fsymmetric_streamX400X2E1X2E0X00X5BmethodX5Dstream_objX2Eread_ready_event(
                                _: *mut u8,
                            ) -> *mut u8;
                        }
                        let ret = symmetricX3AruntimeX2Fsymmetric_streamX400X2E1X2E0X00X5BmethodX5Dstream_objX2Eread_ready_event((self).handle() as *mut u8);
                        super::super::super::symmetric::runtime::symmetric_executor::EventGenerator::from_handle(ret as usize)
                    }
                }
            }
            impl StreamObj {
            ...
            impl StreamObj {
                #[allow(unused_unsafe, clippy::all)]
                pub fn write_ready_event(&self) -> EventGenerator {
                    unsafe {
                        #[link(wasm_import_module = "symmetric:runtime/symmetric-stream@0.1.0")]
                        extern "C" {
                            #[cfg_attr(
                                target_arch = "wasm32",
                                link_name = "[method]stream-obj.write-ready-event"
                            )]
                            fn symmetricX3AruntimeX2Fsymmetric_streamX400X2E1X2E0X00X5BmethodX5Dstream_objX2Ewrite_ready_event(
                                _: *mut u8,
                            ) -> *mut u8;
                        }
                        let ret = symmetricX3AruntimeX2Fsymmetric_streamX400X2E1X2E0X00X5BmethodX5Dstream_objX2Ewrite_ready_event((self).handle() as *mut u8);
                        super::super::super::symmetric::runtime::symmetric_executor::EventGenerator::from_handle(ret as usize)
                    }
                }
            }
