    ...
    fn print_ty(
        ...
        match ty {
            ...
            Type::Id(id) => {
                ...
                match ty {
                    CustomType::Named(ty) => self.push_str(&ty.name.to_camel_case()),
                    CustomType::Anonymous(ty) => match ty {
                        ...
                        AnonymousType::Tuple(t) => self.print_tuple(deps, iface, t),
                        AnonymousType::List(t) => self.print_list(deps, iface, t),
