...
extern "C"
    void
    fooX3AfooX2FresourcesX00X5BmethodX5DrX2Eadd(int32_t arg0, int32_t arg1) {
  exports::foo::foo::resources::R::ResourceRep(arg0)
      ->Add((uint32_t(arg1)));
}
int32_t exports::foo::foo::resources::R::ResourceNew(R *self) {
  return wit::ResourceTable<exports::foo::foo::resources::R*>::store_resource(std::move(self));
}
exports::foo::foo::resources::R *
exports::foo::foo::resources::R::ResourceRep(int32_t id) {
  return *wit::ResourceTable<exports::foo::foo::resources::R*>::lookup_resource(id);
}
void exports::foo::foo::resources::R::ResourceDrop(int32_t id) {
  ...
  exports::foo::foo::resources::R::Dtor(*obj);
}
extern "C" int32_t
...
extern "C" void
fooX3AfooX2FresourcesX00consume(int32_t arg0) {
...
extern "C" void
fooX3AfooX2FresourcesX00X5Bresource_dropX5Dr(int32_t arg0) {
