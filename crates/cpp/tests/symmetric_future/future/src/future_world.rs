    ...
    pub mod future_source {
      ...
      pub fn create() -> wit_bindgen::rt::async_support::FutureReader<u32>{
        unsafe {
          ...
          wit_bindgen::rt::async_support::FutureReader::new(ret, &super::super::super::wit_future::vtable0::VTABLE)
        }
      }
  ...
  pub mod test {
    pub mod test {
      ...
      pub mod future_test {
        ...
        pub unsafe fn _export_create_cabi<T: Guest>() -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
      ...
      macro_rules! __export_test_test_future_test_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          #[allow(non_snake_case)]
          unsafe extern "C" fn testX3AtestX2Ffuture_testX00create() -> *mut u8 {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.42.1:test:test:future-world:encoded world")]
#[doc(hidden)]
