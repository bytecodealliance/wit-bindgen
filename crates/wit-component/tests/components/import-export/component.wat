(component
  ...
  (func (;1;) (canon.lower utf8 (into (instance 2)) (func 0)))
  (instance (;3;) core (export "$imports" (table 0)) (export "a" (func 1)))
  (instance (;4;) (instantiate (module 2) (with "" (instance 3))))
  (alias export (instance 2) "a" (func (;2;)))
  (func (;3;) (canon.lift (type 3) utf8 (into (instance 2)) (func 2)))
  (alias export (instance 2) "bar#a" (func (;4;)))
  (alias export (instance 2) "bar#b" (func (;5;)))
  (func (;6;) (canon.lift (type 4) (func 4)))
  (func (;7;) (canon.lift (type 0) utf8 (into (instance 2)) (func 5)))
  (instance (;5;) (export "a" (func 6)) (export "b" (func 7)))
  (export "a" (func 3))
  (export "bar" (instance 5))
)