...
use wit_parser::{
    ...
    Flags, Function, FunctionKind, Interface, Record, Tuple, Type, TypeDefKind, TypeId, Variant,
};
...
type FunctionKey<'a> = (&'a [(String, Type)], &'a Type);
...
impl<'a> TypeEncoder<'a> {
    ...
    fn encode_func_type(
        ...
        let key = (func.params.as_slice(), &func.result);
