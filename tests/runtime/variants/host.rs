...
impl imports::Imports for MyImports {
    ...
    fn roundtrip_enum(&mut self, a: imports::E1) -> imports::E1 {
        assert_eq!(a, a);
        a
    }
    ...
    fn variant_casts(&mut self, a: imports::Casts) -> imports::Casts {
        a
    }

    fn variant_zeros(&mut self, a: imports::Zeros) -> imports::Zeros {
        a
    }
