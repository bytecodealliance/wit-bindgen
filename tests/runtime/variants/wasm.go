...
func (i VariantsImpl) VariantEnums(a bool, b Result[struct{}, struct{}], c ExportsMyErrno) ExportsTuple3BoolResultEmptyEmptyTMyErrnoT {
	return ExportsTuple3BoolResultEmptyEmptyTMyErrnoT{a, b, c}
}
