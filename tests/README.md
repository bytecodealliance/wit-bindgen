# Testing witx-bindgen - `codegen

Any tests placed into the `tests/codegen` directory should be raw `*.witx`
...
```
$ cargo test -p witx-bindgen-gen-js
```
