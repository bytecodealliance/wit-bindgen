...
rm -f crates/guest-rust/src/rt/libwit_bindgen_cabi_realloc.a
rm -f crates/guest-rust/src/rt/libwit_bindgen_cabi_wasip3.a
...
$WASI_SDK_PATH/bin/llvm-ar crus crates/guest-rust/src/rt/libwit_bindgen_cabi_realloc.a \
  crates/guest-rust/src/rt/wit_bindgen_cabi_realloc.o
$WASI_SDK_PATH/bin/llvm-ar crus crates/guest-rust/src/rt/libwit_bindgen_cabi_wasip3.a \
